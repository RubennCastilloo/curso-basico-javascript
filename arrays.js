...
var borrarFruta = frutas.shift("Uvas"); //Shift nos borra el primer elemento del arreglo

var posicion = frutas.indexOf("Manzana"); //IndexOf nos trae la posicion del elemento del arreglo
